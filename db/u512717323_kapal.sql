...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Feb 2020 pada 05.05
...
--
-- Struktur dari tabel `company_moto`
--
...
CREATE TABLE `company_moto` (
  ...
  `deskripsi_moto_e` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `company_moto`
--
...
--
-- Struktur dari tabel `shipdesign`
--
...
--
-- Dumping data untuk tabel `shipdesign`
--
...
CREATE TABLE `supervisi` (
  ...
  `description` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `description_eng` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_input` text COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Indeks untuk tabel `company_moto`
--
...
--
ALTER TABLE `achievement`
  MODIFY `id_achievement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT untuk tabel `company_moto`
--
ALTER TABLE `company_moto`
...
--
-- AUTO_INCREMENT untuk tabel `ispscode`
--
ALTER TABLE `ispscode`
...
--
-- AUTO_INCREMENT untuk tabel `shipdesign`
--
ALTER TABLE `shipdesign`
