                        ...
                        <ul>
                            ...
                            foreach ($data->result() as $row) {
                                ...
                                <li>
                                    ...
                                    <div>
                                        <h3><a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->nm_project_seo; ?>"><?php echo $row->nm_project; ?></a></h3>
                                        <p class="date"><?php echo date("d F Y", strtotime($row->tgl_mulai)); ?></p>
                                        <p>
                                            <?php
                                                echo character_limiter($row->description, 250);
                                            ?>
                                        </p>
                                        <a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->nm_project_seo; ?>" >Read more &rsaquo;&rsaquo;</a>
    <!--                                    <p class="tags">Tag</p>-->
                                    </div>
                                </li>
                                <?php
